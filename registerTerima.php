...
<head>
    ...
    <title>Daftar Penerima - Food Sharing</title>
    <link rel="stylesheet" href="css/auth.css">
</head>
<body>
    <a href="loginTerima.php" class="back-link">←</a>
    ...
    <div class="auth-container">
        <div class="auth-header">
            ...
            <h1 class="auth-title">Daftar Penerima</h1>
            <p class="auth-subtitle">Bergabung untuk mengurangi sampah makanan</p>
        </div>
        ...
        <div class="auth-links">
            <p>Sudah punya akun? <a href="loginTerima.php">Login di sini</a></p>
        </div>
    </div>
